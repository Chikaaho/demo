                ...
                <tbody>
                    <c:forEach var="books" items="${list}">
                        <tr>
                            ...
                            <td>
                                <a href="${pageContext.request.contextPath}/book/updateBookPage?id=${books.books_id}">修改</a>
                                &nbsp; || &nbsp;
                                <a href="${pageContext.request.contextPath}/book/deleteBook/${books.books_id}">删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
